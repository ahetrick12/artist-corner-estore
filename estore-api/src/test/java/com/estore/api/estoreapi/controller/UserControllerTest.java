...
public class UserControllerTest {
    ...
    public void testCreateUserFailed() throws IOException {  // createUser may throw IOException
        // Setup
        User user = new User(99, "FailedUsername", "FailedPassword", new CartItem[1], "dog.jpg");
    ...
    public void testCreateUserHandleException() throws IOException {  // createUser may throw IOException
        // Setup
        User user = new User(99, "ExceptionUsername", "ExceptionPassword", new CartItem[1], "dog.jpg");
    ...
    //     // Setup
    //     User user = new User(99, "UN", "PW", new CartItem[1], "dog.jpg");
    ...
    public void testGetUsers() throws IOException { 
        ...
        users[0] = new User(99, "Username", "Password", new CartItem[1], "dog.jpg");
        users[1] = new User(100, "Test123", "12345", new CartItem[1], "dog3.jpg");
    ...
    public void testFindUser() throws IOException {
        ...
        users[0] = new User(99, "Username", "Password", new CartItem[1], "dog.jpg");
        users[1] = new User(100, "Test123", "12345", new CartItem[1], "dog.jpg");
        users[2] = new User(100, "safjakslf", "213912837", new CartItem[1], "dog.jpg");
    ...
    public void testFindUserFailed() throws IOException {
        ...
        User[] users = new User[3];
        users[0] = new User(99, "Username", "Password", new CartItem[1], "dog.jpg");
        users[1] = new User(100, "Test123", "12345", new CartItem[1], "dog2.jpg");
        users[2] = new User(100, "safjakslf", "213912837", new CartItem[1], "dog3.jpg");
